...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2020 at 10:04 PM
...
CREATE TABLE `user` (
  ...
  `personal_data` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user` (`id`, `name`, `password`, `role`, `personal_data`) VALUES
(7, 'admin1', '$2y$10$PDgD6kcISQhSXmEP2PGZfu0oHQkj/CZ2PT7CzRhUhyk18WF8Oh73K', 'admin', 'U Khin Maung Aye, MD'),
(8, 'user1', '$2y$10$Hp7vTo9Uia7ujWWIdEIGVOz3Yuniz.fNd0VHn8pdYUZJfbVL/4hxy', 'user', 'Daw Ni Ni Khin Zaw, GM');

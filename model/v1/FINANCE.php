...
class FINANCE{
        ...
        public function dashboard($data){
                ...
                $finances = R::find('finance',' ( created_date BETWEEN ? AND  ? )  AND ( ops = ? OR ops = ? )', [ $start_date,$end_date,$income, $expense]);
                $return_data = array();
                $test;
                foreach($finances AS $index=>$finance){
                ...
                return_success("finance->dashboard ".count($return_data),$return_data);
        }
